...
export default function TimelineInfoGrid({ schedule, concertCoords }: TimelineInfoGridProps) {
  ...
  const transportMap: Record<string, string> = {
    WALK: "foot",
    PUBLIC_TRANSPORT: "publictransit",
    CAR: "car",
  };
  const transport = transportMap[schedule.transportType!] || "car";

  const kakaoUrl = `http://m.map.kakao.com/scheme/route?sp=${schedule.startPlaceLat},${schedule.startPlaceLon}&ep=${schedule.endPlaceLat},${schedule.endPlaceLon}&by=${transport}`;
